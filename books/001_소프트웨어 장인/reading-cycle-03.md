...
<@ @SUMMARY
<#
🧠 세 번째 장은 ‘소프트웨어 장인정신’을 단순한 기술 능력이 아닌, 태도와 철학으로 정의하며 시작한다.

- 장인은 단순히 코드를 잘 짜는 사람이 아니라, 의미 있는 실천과 자기 수양, 타자와의 관계를 고려하며 일에 내재된 만족을 추구하는 사람이다.
- 제품은 사용자에게 감지되지 않을수록 좋은 것으로 평가되지만, 개발자가 스스로 만든 산출물을 공예품으로 여기고 정성을 다할 때 진정한 장인정신이 드러난다.
- 하지만 이러한 장인정신은 외부로부터 쉽게 인정받기 어렵고, 고객조차 ‘생산자적 동반자’가 되지 못하는 경우가 많아 외로울 수 있다.
- 그럼에도 불구하고 장인은 내적으로 가치를 찾아 묵묵히 이어간다.
- 소프트웨어 장인은 고용주나 고객을 선택할 줄 알아야 하며, 함께 의미 있는 결과를 만들 수 있는 ‘관계’를 만들어야 한다.
- ‘최고의 제품을 만들고 싶은 이유’가 동기이자 기준이 되어야 하며, 그것이 없다면 진정한 프로페셔널 관계라 보기 어렵다.
- 실력보다 중요한 것은 마음가짐이며, 스스로 선택한 커리어에 책임을 지고 끊임없이 배우고 나누려는 자세가 핵심이다.
- 기능만을 채우는 개발자가 아닌, 가치를 전달하고 낭비를 줄이는 개발자가 바로 장인이다.
- 결국 소프트웨어 장인정신은 ‘잘 만드는 것’보다 ‘왜 잘 만들어야 하는지’를 묻는 자세이며, 그 질문을 포기하지 않는 사람이 장인이라 할 수 있다.
#>
<## @Distilled Sentence
🧷 소프트웨어 장인정신은 기술이 아닌 태도와 책임의 문제이며, 보이지 않는 가치를 위해 묵묵히 최선을 다하는 프로페셔널의 자세다.
##>
@>
